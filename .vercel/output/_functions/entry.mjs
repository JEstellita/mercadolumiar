...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_CMMxf5S2.mjs';
import { manifest } from './manifest_C42C-7Jy.mjs';
...
const _page7 = () => import('./pages/produtores.astro.mjs');
const _page8 = () => import('./pages/robots.txt.astro.mjs');
const _page9 = () => import('./pages/sobre.astro.mjs');
const _page10 = () => import('./pages/whatsapp.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/produtores.astro", _page7],
    ["src/pages/robots.txt.ts", _page8],
    ["src/pages/sobre.astro", _page9],
    ["src/pages/whatsapp.ts", _page10],
...
const _args = {
    "middlewareSecret": "6f351e7e-4913-46f7-81dc-e09c3046ff58",
